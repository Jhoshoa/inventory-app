...
export default function RegisterScreen() {
  return (
    <View className="flex-1 justify-center p-6 bg-white">
      ...
      <TextInput className="border border-gray-300 rounded-lg p-3 mb-4" placeholder="Nombre completo" />
      ...
      <TextInput className="border border-gray-300 rounded-lg p-3 mb-4" placeholder="Nombre de tienda" />
