...
async def get_inventory_import(
    ...
    return await GetInventoryImportUseCase(repo).execute(user.store_id, import_id)
...
async def cancel_inventory_import(
    ...
    return await CancelInventoryImportUseCase(repo).execute(user.store_id, import_id)
