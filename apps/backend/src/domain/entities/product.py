...
def product_discount_per_unit(price: Decimal, discount_type: str | None, discount_value: Decimal) -> Decimal:
...
class Product:
    ...
    def discount_per_unit(self) -> Decimal:
        """Cuanto se descuenta del precio de lista por cada unidad vendida."""
        return product_discount_per_unit(self.price, self.discount_type, self.discount_value)
