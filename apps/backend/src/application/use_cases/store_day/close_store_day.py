    ...
    async def execute(self, input: CloseStoreDayInput) -> StoreDayResponseDTO:
        ...
        cash_movement_summary = (
            ...
            if self._cash_movement_repo
                ...
                "cash_movements_in_total": Decimal("0"),
                "cash_movements_out_total": Decimal("0"),
                "cash_movements_count": 0,
            }
        )
        opening_cash = business_day.opening_cash_amount or Decimal("0")
        cash_sales = summary["cash_sales_total"]
        cash_movements_in = cash_movement_summary["cash_movements_in_total"]
        cash_movements_out = cash_movement_summary["cash_movements_out_total"]
        expected_cash = opening_cash + cash_sales + cash_movements_in - cash_movements_out
        ...
        business_day.close(
            ...
            cash_movements_count=cash_movement_summary["cash_movements_count"],
